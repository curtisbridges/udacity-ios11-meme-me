...
class MemeEditorViewController: UIViewController {
    ...
    func isUserEditing() -> Bool {
        return topButton.currentTitle != "TOP" || bottomButton.currentTitle != "BOTTOM" || imageView.image != nil
    }

    func handleInterfaceState() {
    ...
    @IBAction func changeTopText(_ sender: UIButton) {
        print("Change top text")
    }

    @IBAction func changeBottomText(_ sender: UIButton) {
        print("Change bottom text")
    }
    ...
    @IBAction func doCancel(_ sender: UIBarButtonItem) {
        topButton.titleLabel?.text = "TOP"
        bottomButton.titleLabel?.text = "BOTTOM"
        imageView.image = nil
    }
